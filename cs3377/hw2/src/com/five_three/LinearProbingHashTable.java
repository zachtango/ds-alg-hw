...
public class LinearProbingHashTable<AnyType> {
    ...
    public void insert(AnyType x){
        ...
        // need to rehash once table is nearly full for efficiency
        if(++currentSize > (table.length - table.length / 5))
            rehash();
    }
    ...
    private int findPos(AnyType x){
        ...
        // handle collisions in a linear prob way (increment by 1 until finding an open index)
